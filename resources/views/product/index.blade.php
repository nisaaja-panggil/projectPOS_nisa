...
<div class="col-md-12">
    <div class="card card-info">
        <div class="card-header">
            ...
            <a type="button" class="btn btn-success float-right" href="{{ route('product.create') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a type="button" class="btn btn-warning" href="{{ route('product.edit',$dt->id) }}">
                                    <i class=" fas fa-edit"></i>
                                </a>
                                <a type="button" class="btn btn-success" href="{{ route('product.show',$dt->id) }}">
